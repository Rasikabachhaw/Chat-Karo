...
3. Enter project name: `ChatApp-Auth`
4. Click "Create"

### 1.2 Enable Google+ API
1. In the Google Cloud Console, go to "APIs & Services" → "Library"
2. Search for "Google+ API" and enable it
3. Also enable "Identity ToolKit API" API
...
4. Now Click on Create OAuth Client --> Application type: Web application
5. Name: ChatApp Web Client
