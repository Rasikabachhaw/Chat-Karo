      ...
      <div className="hero min-h-screen bg-gradient-to-br from-primary to-secondary flex justify-center items-center">
        <div className="hero-content text-center text-primary-content">
          <div className="max-w-md">
            <motion.h1
              className="mb-5 text-5xl font-bold font-sans"
            ...
            <motion.p
              className="mb-5 text-lg font-sans"
              initial={{ opacity: 0, skewX: 90 }}
              animate={{ opacity: 1, skewX: 0 }}
              transition={{ duration: 1 }}
            >
              Connect, chat, and communicate with people around the world.
              Experience seamless messaging with beautiful themes and modern
              design.
            </motion.p>
            <div className="flex gap-4 justify-center">
              ...
              >
                <Link
                  to="/register"
                  className="btn btn-accent btn-lg font-sans"
                >
                  Get Started
                </Link>
              </motion.div>
              <motion.div
                ...
                transition={{ duration: 1 }}
              >
                <Link to="/about" className="btn btn-outline btn-lg font-sans">
                  Learn More
                </Link>
              </motion.div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="card bg-base-100 shadow-xl">
              <div className="card-body text-center">
                ...
                <h3 className="card-title justify-center font-sans">
                  Real-time Messaging
                </h3>
            ...
            <div className="card bg-base-100 shadow-xl">
              <div className="card-body text-center">
                ...
                <p className="font-sans">
                  Multiple stunning themes to personalize your chat experience.
                </p>
              </div>
            </div>
      ...
      <div className="py-16 bg-primary text-primary-content">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 font-sans">
            Join thousands of users already enjoying ChatKro
          </p>
          <div className="flex gap-4 justify-center">
            <Link to="/register" className="btn btn-accent btn-lg font-sans">
              Sign Up Now
            </Link>
            <Link to="/chat" className="btn btn-outline btn-lg font-sans">
              Try Demo
            </Link>
          </div>
        </div>
